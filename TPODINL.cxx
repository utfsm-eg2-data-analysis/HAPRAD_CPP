...
TPODINL::TPODINL(const TRadCor* rc, double tau, double mu, const TStructFunctionArray& H0, const TThetaMatrix& theta)
...
ROOT::Math::IBaseFunctionOneDim* TPODINL::Clone() const { return 0; }
