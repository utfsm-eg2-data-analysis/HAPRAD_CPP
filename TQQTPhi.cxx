...
ROOT::Math::IBaseFunctionOneDim* TQQTPhi::Clone() const { return 0; }

double TQQTPhi::DoEval(double phi) const {
  ROOT::Math::GSLIntegrator ig(ROOT::Math::IntegrationOneDim::kADAPTIVE, ROOT::Math::Integration::kGAUSS21);
